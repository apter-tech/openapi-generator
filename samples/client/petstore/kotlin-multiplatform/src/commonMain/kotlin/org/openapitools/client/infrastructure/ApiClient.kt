...
open class ApiClient(
    ...
    fun setUsername(username: String) {
        val auth = authenticationsvaluesfirstOrNull { it is HttpBasicAuth } as HttpBasicAuth?
    ...
    fun setApiKey(apiKey: String, paramName: String? = null) {
        val auth = authenticationsvalues
    ...
    fun setAccessToken(accessToken: String) {
        val auth = authenticationsvalues.firstOrNull { it is OAuth } as OAuth?
    ...
    fun setBearerToken(bearerToken: String) {
        val auth = authenticationsvalues.firstOrNull { it is HttpBearerAuth } as HttpBearerAuth?
